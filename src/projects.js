export const projects = [
  ...
  },
  {
    ...
    cardImage: "/Portfolio/portfolio-card.png",
    tech: {
  ...
  },
  {
    ...
    summary: "A board game review site with integrated back-end!",
    longDescription:
      "The House of Games was a project created during my time with Northcoders, as a front-end means to connect with the REST api I created prior. Users are able to browse the website as a guest and view all of the latest reviews, but if they log in using one of the pre-existing accounts, they are able to access a multitude of additional features, such as the ability to post new reviews, comment and like existing reviews, and delete their own comments and reviews they've posted. Users are also able to sort and filter search results using a combination of different queries. The site is responsive and was designed and developed with a mobile-first approach.",
    cardImage: "/House-Of-Games-Api/house-of-games-api-card.png",
    images: [
      "/Know-It-All/know-it-all-1.png",
      "/Know-It-All/know-it-all-2.png",
      "/Know-It-All/know-it-all-3.png",
  ...
  },
  {
    ...
    cardImage: "/House-Of-Games/house-of-games-card.png",
    images: [
      "/Know-It-All/know-it-all-1.png",
      "/Know-It-All/know-it-all-2.png",
      "/Know-It-All/know-it-all-3.png",
